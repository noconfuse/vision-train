...
const api = {
  ...
  startDatasetSnapshot(data) { return post('/dataset/snapshot/start', data); },
  ...
  createEmptyDataset(data) { return post('/dataset/create_empty', data); },
  ...
  addDatasetLabel(data) { return post('/dataset/add_label', data); },
