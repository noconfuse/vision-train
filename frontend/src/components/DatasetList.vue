      ...
      <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
        <div v-for="ds in datasets.trainable" 
          ...
          <div class="mt-4 pt-4 border-t border-gray-100 flex gap-2 justify-end" @click.stop>
            <button @click="goToHistory(ds)" class="px-3 py-1.5 text-xs font-medium bg-emerald-50 text-emerald-700 hover:bg-emerald-100 rounded-lg transition-colors">
              📜 历史
            </button>
